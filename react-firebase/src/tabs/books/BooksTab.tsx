...
export function BooksTab({
  ...
  const undownloaded = useUndownloaded();
    ...
    <div>
      ...
      <div className="grid-head">
        ...
        <div style={{ display: 'flex', gap: 6 }}>
          ...
          >
            {importBook.isPending ? 'Abriendo…' : 'Abrir libro (JSON)'}
          </button>
      ...
      {books.length === 0 ? (
        <p className="empty-note">
          Todavía no hay libros en este navegador. Crea el primero o abre un JSON que hayas
          descargado antes.
        </p>
      ) : (
                ...
                <div className="list-card-title">
                  ...
                  {undownloaded[b.id] && (
                    <span
                      ...
                      style={{ marginLeft: 8 }}
                      title="Tiene cambios que sólo existen en este navegador"
                    >
                      sin descargar
                    </span>
                  )}
