...
import { Avatar, ConfirmDialog, ErrorBanner, Prose, Section, Spinner } from '../../components/ui';
  ...
  return (
    <div className="detail">
      {/* Fuera de detail-head: en móvil la cabecera se apila y el botón debe
          quedar arriba del todo, no debajo del avatar. Oculto en escritorio. */}
      <button className="btn btn-ghost btn-sm back-btn" onClick={onBack}>
        ← Personajes
      </button>

      <div className="detail-head">
        <Avatar name={character.name} large />
