    ...
    <div>
      <div className="grid-head" style={{ marginBottom: 12 }}>
        ...
        <div style={{ display: 'flex', gap: 6 }}>
          {/* JSON: el libro entero (personajes, capítulos con su texto, trama),
              el mismo formato que "Gestionar libros" — sirve para llevárselo a
              otro sitio o tener una copia. Markdown: sólo lo que se ve en esta
              pantalla, para leer o compartir. Son dos exportaciones distintas
              a propósito, no una redundante con la otra. */}
          <button
      ...
      <ErrorBanner error={exportBook.error} />
